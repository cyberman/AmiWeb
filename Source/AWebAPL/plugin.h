...
#ifndef AWEB_PLUGIN_H
#define AWEB_PLUGIN_H
...
{  long structsize;     /* Set to struct size by caller */
   ...
   UBYTE *data;         /* Block of data or NULL */
   long length;         /* Length of data */
   BOOL eof;            /* TRUE if EOF was reached */
   UBYTE *contenttype;  /* MIME content-type of data */
   UBYTE *url;          /* URL of this file */
