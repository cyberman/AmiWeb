...
extern void Getjspart(void *url,USHORT which,UBYTE **start,long *length);
   /* Finds this part of the URL's url string */

extern void *Repjspart(void *url,USHORT which,UBYTE *part);
...
extern BOOL Issamehost(void *url1,void *url2);
