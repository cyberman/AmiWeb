...
/* pluginlib.h
 *
 * AWeb EML email plugin module project dependent header file
 *
...
#define PLUGIN_LIBNAME     "awebeml.awebplugin"
#define PLUGIN_LIBID       "eml 1.0 " __AMIGADATE__
#define PLUGIN_SIZE        sizeof(struct EmlBase)
