...
typedef version_1_0_69 Your_png_h_is_not_version_1_0_69;
...
png_get_copyright(png_structp png_ptr)
{
   ...
   return ((png_charp) PNG_STRING_NEWLINE \
     "libpng version 1.0.69 - September 28, 2017" PNG_STRING_NEWLINE \
     "Copyright (c) 1998-2002,2004,2006-2017 Glenn Randers-Pehrson" \
     PNG_STRING_NEWLINE \
     ...
     PNG_STRING_NEWLINE);
#else
   return ((png_charp) "libpng version 1.0.69 - September 28, 2017\
      Copyright (c) 1998-2002,2004,2006-2017 Glenn Randers-Pehrson\
