...
/* pluginlib.h
 *
 * AWeb RSS/Atom plugin module project dependent header file
 *
...
#define PLUGIN_LIBNAME     "awebrss.awebplugin"
#define PLUGIN_LIBID       "rss 1.0 " __AMIGADATE__
#define PLUGIN_SIZE        sizeof(struct RssBase)
